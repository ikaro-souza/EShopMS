...
// public record class GetProductsByCategoryRequest(string Category);
public record class GetProductsByCategoryResponse(IEnumerable<Product> Products);
...
public class GetProductsByCategoryEndpoint : ICarterModule
{
    public void AddRoutes(IEndpointRouteBuilder app)
    {
        app.MapGet("/products/category/{category}", async (string category, ISender sender) =>
            ...
            .WithSummary("Get a product by its category")
